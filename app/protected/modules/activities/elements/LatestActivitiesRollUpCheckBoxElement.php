<?php
    ...
    /**
     * Displays a rollup checkbox with a label that differs depending on if the checkbox is selected or not.
     */
    class LatestActivitiesRollUpCheckBoxElement extends CheckBoxElement
    {
        /**
        ...
        protected function renderLabel()
        {
            ...
            {
                $label = Yii::t('Default', 'Roll Up Off');
            }
            if ($this->form === null)
            {
