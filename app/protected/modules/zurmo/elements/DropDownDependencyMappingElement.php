<?php
    ...
    /**
     * Displays the mapping interface
     * which is used by the Designer module
     * to allow drop downs to be connected together in a dependency.
     */
    class DropDownDependencyMappingElement extends Element
    {
        ...
        protected function renderControlEditable()
        {
            ...
            return 'something will go here eventulaly';
        ...
        protected function getModelRelationsCustomFieldsAndLabels()
        {
            //check params, should be there...
        }
