<?php
    ...
    class AttributeCreateView extends MetadataView
    {
        protected $controllerId;
        protected $moduleId;

        public function __construct($controllerId, $moduleId, $moduleClassName)
        {
        ...
        protected function renderContent()
        {
            ...
            foreach ($attributeTypes as $attributeType)
            {
                ...
                $content .= '<tr>';
                $content .= '<th>' .
                CHtml::link($attributeFormClassName::getAttributeTypeDisplayName(),
                    Yii::app()->createUrl('/' . $this->moduleId . '/' . $this->controllerId . '/attributeEdit',
                        array(
                ...
                $content .= '<td>' . $attributeFormClassName::getAttributeTypeDisplayDescription() . '</td>';
                $content .= '</tr>';
            }
            $content .= '</tbody>';
            $content .= '</table>';
