        ...
        public function afterValidate()
        {
            ...
            if (count($this->getErrors()) == 0)
            {
                ...
                if ($this->databaseAdminUsername != null)
                {
                    ...
                    $connectionResult = DatabaseCompatibilityUtil::checkDatabaseConnectionRaw($this->databaseType,
                    ...
                    $userExistsResult = DatabaseCompatibilityUtil::checkDatabaseUserExistsRaw($this->databaseType,
                                                                             $this->databaseHostname,
                                                                             $this->databaseAdminUsername,
                                                                             $this->databaseAdminPassword,
                    ...
                    $databaseExistsResult = DatabaseCompatibilityUtil::checkDatabaseExistsRaw($this->databaseType,
                                                                             $this->databaseHostname,
                                                                             $this->databaseAdminUsername,
                                                                             $this->databaseAdminPassword,
                                                                             $this->databaseName);
                    ...
                    $createDatabaseResult = DatabaseCompatibilityUtil::createDatabaseRaw($this->databaseType,
                                                                             $this->databaseHostname,
                                                                             $this->databaseAdminUsername,
                                                                             $this->databaseAdminPassword,
                                                                             $this->databaseName);
                    ...
                    $createUserResult = DatabaseCompatibilityUtil::createDatabaseUserRaw($this->databaseType,
                                                                             $this->databaseHostname,
                                                                             $this->databaseAdminUsername,
                                                                             $this->databaseAdminPassword,
                                                                             $this->databaseName,
