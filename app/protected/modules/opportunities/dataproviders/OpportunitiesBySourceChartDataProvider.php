<?php
    ...
    class OpportunitiesBySourceChartDataProvider extends ChartDataProvider
    {
        ...
        public function getChartData()
        {
            ...
            $sql  = "select {$quote}customfield{$quote}.{$quote}value{$quote} source, ";
            ...
            $sql .= "where {$quote}opportunity{$quote}.{$quote}source_ownedcustomfield_id{$quote} = ";
            ...
            foreach ($rows as $row)
            {
                $chartData[] = array(
                    ...
                    'displayLabel' => $row['source'], //todo: at some point translate to locale language once defined.
                );
            }
            return $chartData;
        }
