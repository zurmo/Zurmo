<?php
    ...
    // 5. $seleniumUserExtensionsJSPath is path to the user-extension.js, so as to enable the use of global variables
    // 6. $seleniumServerPort - selenium server port
    // 7. $seleniumBrowsersToRun - list of browsers to run functional tests in
    // For more details, please check protected/tests/functional/TestSuite.php
    $seleniumServerPath             = '';
    $seleniumTestBaseUrl            = '';
    $seleniumTestResultUrl          = '';
    $seleniumTestResultsPath        = '';
    $seleniumUserExtensionsJSPath   = '';
